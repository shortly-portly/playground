defmodule PlaygroundWeb.SelectComponent do
  ...
  def render(assigns) do
    ~H"""
    <div class="flex" >
      <div class="border border-gray-200 dark:border-gray-700 w-96 h-12 pb-2 m-2 w-96 flex relative" 
      ...
      <div class="hidden w-96 mt-4 p-4 ml-2 mt-16 absolute z-10 bg-stone-50 shadow-2xl rounded-lg" id={"#{@id}-options-container"}> 
    ...
    <div> 
      <%= hidden_input(@form, @field, value: @selected_id) %>
    </div>
    </div>
    """
  end
